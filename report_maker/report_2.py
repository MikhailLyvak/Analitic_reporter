...
def report_2(data: list, month: int, sum_data: list) -> None:
    titles = [
            "Назва фірми",
            "Менеджер",
            "Сума продаж",
    ...
    res2 = Report(data=data, report_name=f"Продажи по фірмам за {month.lower()} місяць")
